	...
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				...
				<a class="brand" href="\index.html">Site Home</a>
				...
				<div class="nav-collapse">
					...
					<?php if (getOption('zpB_homepage')) { ?>
						<li<?php if ((isset($isHomePage)) && ($isHomePage)) { ?> class="active"<?php } ?>><a href="<?php echo html_encode(getGalleryIndexURL(false)); ?>" title="<?php echo gettext('Gallery Home'); ?>"><?php echo gettext('Gallery Home'); ?></a></li>
